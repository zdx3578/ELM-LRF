...
for a = 1:param.tile_size
    for b = 1:param.tile_size
        ...
        fprintf('af for ;tied_units size is %f %f \n',size(tied_units)  );


tied_units = repmat(tied_units, param.num_maps,1);
        fprintf('af repmat ; tied_units size is %f %f  \n',size(tied_units)  );
...
for a = 1:length(offset)
    tied_units{a} = tied_units{a} + offset(a);
        ...
        fprintf('af offset;  tied_units size is %f %f \n',size(tied_units)  );
end
